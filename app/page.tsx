...
export default function Home() {
  return (
    <>
      ...
      <main className="relative min-h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-40 bg-white text-gray-800 font-sans overflow-hidden gap-10">
        {/* Floating stats - only show on md+ screens */}
        <div className="hidden md:block absolute top-48 right-90 bg-white rounded-2xl shadow-xl p-3 animate-float z-10 overflow-hidden transition-all duration-300 w-15 hover:w-auto group origin-right">
        ...
        <div className="hidden md:block absolute top-69 right-71 bg-white rounded-2xl shadow-xl p-3 animate-float z-20 overflow-hidden transition-all duration-300 w-15 hover:w-auto group origin-right">
          <div className="flex items-center gap-2 whitespace-nowrap">
            <LinkedInLink />
            <span className="text-sm text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              LinkedIn
        ...
        <div className="hidden md:block absolute top-97 right-64 bg-white rounded-2xl shadow-xl p-3 animate-float z-20 overflow-hidden transition-all duration-300 w-15 hover:w-auto group origin-left">
          <div className="flex items-center gap-2 whitespace-nowrap">
            <GitHubLink />
            <span className="text-sm text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              GitHub
        ...
        <div className="hidden md:block absolute top-120 right-75 bg-white rounded-2xl shadow-xl p-3 animate-float z-20 overflow-hidden transition-all duration-300 w-15 hover:w-auto group origin-right">
          <div className="flex items-center gap-2 whitespace-nowrap">
            <InstagramLink />
            <span className="text-sm text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              Instagram
        ...
        {/* <div
          className="hidden md:block absolute bottom-12 left-32 bg-white rounded-2xl shadow-xl p-4 animate-float z-20"
        ...
        <section className="md:w-1/2 flex flex-col justify-center space-y-6 z-10 wave-on-hover">
          ...
          <p className="max-w-lg text-gray-600 text-base leading-relaxed text-justify">
            I’m a{" "}
            <span className="text-indigo-600 font-medium">BCA student</span>{" "}
            dedicated to building clean and user-friendly websites. I believe
            simplicity is the ultimate sophistication, and creativity is in
            every detail.
          </p>
        ...
        <div className="hidden md:block absolute top-40 left-20 w-38 h-38 bg-indigo-100 rounded-xl rotate-12 opacity-30 pointer-events-none"></div>
